...
var (
	...
	// start block
	ethStartBlock = uint64(4933174)

	tronStartBlock = uint64(4933174)
	bttcStartBlock = uint64(4933174)
	// factory address
	ethFactoryAddress = common.HexToAddress("0x0c9de531dcb38b758fe8a2c163444a5e54ee0db2")
	ethOracleAddress  = common.HexToAddress("0x0c9de531dcb38b758fe8a2c163444a5e54ee0db2")
